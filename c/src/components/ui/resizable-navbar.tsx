    ...
    >
      {items.map((item, idx) => (
        ...
        >
          ...
          <span className="relative z-20 font-bold text-md dark:text-white">{item.name}</span>
        </div>
      ))}
    </motion.div>
  );
  ...
  return (
    ...
    >
      <Image
        ...
        height={30}
      />
      <span className="font-medium text-black dark:text-white">Project Manager</span>
    </a>
  );
};
