const adminGetAllEmployee = async (token:string,page: number, limit: number) => {
  const res = await fetch(`${process.env.NEXT_PUBLIC_URL_SERVER}/employees?page=${page || 1}&limit=${limit || 10}`,{
    method: 'POST',
    headers: {
...
const adminCreateEmployee = async (data:any) => {
  const res = await fetch(`${process.env.NEXT_PUBLIC_URL_SERVER}/employees`,{
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
const getInfo = async (token:string) => {
  const res = await fetch(`${process.env.NEXT_PUBLIC_URL_SERVER}/employees/info`,{
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      'Authorization': `Bearer ${token}`
...
const adminGetEmployeeById = async (token:string,id:number) => {
  const res = await fetch(`${process.env.NEXT_PUBLIC_URL_SERVER}/employees/${id}`,{
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
      'Authorization': `Bearer ${token}`
...
const adminCreateTeam = async (token:string,data:{team_name:string,description:string}[]) => {
  const res = await fetch(`${process.env.NEXT_PUBLIC_URL_SERVER}/employees/team`,{
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      'Authorization': `Bearer ${token}`
...
const adminGetTeamMember = async (token:string,id:number) => {
  const res = await fetch(`${process.env.NEXT_PUBLIC_URL_SERVER}/employees/team/member/${id}`,{
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
      'Authorization': `Bearer ${token}`
