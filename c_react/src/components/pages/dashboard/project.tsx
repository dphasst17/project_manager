...
const Project = () => {
  ...
  return <div className="w-full h-full col-span-7 bg-zinc-900 text-white p-1 rounded-md">
          ...
          data.map((item:any) => (
            <TableRow key={item.project_id}>
              ...
              <TableCell className="flex justify-around">
                {(isAdmin || isManager) && 
                  <ScanEye onClick={() => {navigate(`/project/${item.project_id}`)}} className="cursor-pointer" />
                }
